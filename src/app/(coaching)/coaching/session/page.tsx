...
function CoachingSessionUI() {
  ...
  const nodeMapping = currentNode ? coachingConfig.nodeMap[currentNode] : null;
  const visualizerColor = nodeMapping?.auraColor ?? coachingConfig.theme.auraColor;
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <StatusBar agentConfig={coachingConfig} />
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        <BaseTranscript
          ...
          agentName={coachingConfig.displayName}
        />
      </div>
